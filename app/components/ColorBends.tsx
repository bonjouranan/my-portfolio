// 📍 文件: app/components/ColorBends.tsx (已添加“亮度”参数的最终版)
...
type ColorBendsProps = {
  ...
  parallax?: number;
  transparent?: boolean;
  brightness?: number; // ✨ 新增：亮度参数
};

const MAX_COLORS = 8 as const;

// 👇【重要】这是背景的“发动机”代码，我在这里为它增加了一个 uBrightness 参数
const frag = `
...
uniform float uBrightness; // ✨ 新增：亮度 uniform
varying vec2 vUv;
...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uNoise: { value: noise },
        uBrightness: { value: brightness }, // ✨ 新增：将亮度值传入 uniform
      },
  ...
  useEffect(() => {
    ...
    material.uniforms.uBrightness.value = brightness; // ✨ 新增：同步亮度值
